...
class HSTLM(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_size, word_to_idx, glove_path):
        super(LSTM,self).__init__()
        #load pretrained gloVe embeddings, copy data to nn.Embedding, and set trainable to false
        ...
        self.sent_LSTM = nn.LSTM(embedding_dim, hidden_size, 1, batch_first = False)
        ...
        self.doc_LSTM_init_state = 0
        self.sent_LSTM_init_state = 0
    ...
    def load_glove(self, fpath):
        ...
        return words
    def initialize_states(self, bs, lstm_type):
