...
class GRU(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_size, word_to_idx, glove_path):
        ...
        self.doc_GRU = nn.GRU(embedding_dim, hidden_size, 1, batch_first = False)
    ...
    def forward(self, input):
        ...
        hidden_features, _ = self.doc_GRU(word_embeddings, self.initial_states)
    ...
    def initialize_states(self, bs):
        ...
        return (torch.zeros(self.doc_GRU.num_layers, bs, self.hidden_size, device="cuda:0"))
